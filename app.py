...
if job_desc_file is not None:
    ...
    if op == "Yes, I have":
        ...
        if resume_file is not None:
            opt = st.sidebar.selectbox("Available Options", ["Choose an option","Percentage match", "Show Relevant Skills", "Non-relevant Skills", "Recommended Skills", "Tell Me About the Resume"])
